...
const forumFeatures = [
  {
    ...
    description: 'Rencontres directes entre étudiants, diplômés et recruteurs des meilleures entreprises du secteur agricole.',
    benefits: ['Contacts qualifiés', 'Opportunités immédiates', 'Conseils d\'experts', 'Réseau durable']
  },
  {
    icon: Briefcase,
    title: 'Opportunités d\'Emploi',
    description: 'Accès exclusif aux postes et stages dans l\'ingénierie agronomique et secteurs connexes.',
    benefits: ['Offres exclusives', 'Entretiens directs', 'Stages qualifiants', 'CDI proposés']
  },
  {
    icon: Award,
    title: 'Ateliers de Formation',
    description: 'Sessions spécialisées pour améliorer les compétences et la préparation professionnelle.',
    benefits: ['CV optimisé', 'Techniques d\'entretien', 'Soft skills', 'Personal branding']
  },
  {
    icon: TrendingUp,
    title: 'Panels Sectoriels',
    description: 'Conférences sur les tendances du marché et l\'avenir de l\'agriculture durable.',
    benefits: ['Vision marché', 'Innovations', 'Opportunités futures', 'Expertise sectorielle']
  }
];

const timeline2025 = [
  { time: '09h00-09h30', activity: 'Accueil & Inscription', type: 'logistique' },
  { time: '09h30-10h00', activity: 'Cérémonie d\'Ouverture', type: 'officiel' },
  { time: '10h00-12h00', activity: 'Sessions Networking - Première Phase', type: 'networking' },
  { time: '12h00-13h30', activity: 'Pause Déjeuner & Networking Informel', type: 'pause' },
  { time: '13h30-15h00', activity: 'Ateliers de Formation Parallèles', type: 'formation' },
  { time: '15h00-15h30', activity: 'Pause-Café & Échanges', type: 'pause' },
  { time: '15h30-17h00', activity: 'Sessions Recrutement - Entretiens', type: 'recrutement' },
  { time: '17h00-18h00', activity: 'Panel: Avenir de l\'Agriculture Durable', type: 'conference' },
  { time: '18h00-18h30', activity: 'Clôture & Networking Final', type: 'cloture' }
];
...
const getTypeColor = (type: string) => {
  switch (type) {
    case 'officiel': return 'from-brand-green to-emerald-600';
    case 'networking': return 'from-blue-500 to-cyan-600';
    case 'formation': return 'from-purple-500 to-indigo-600';
    case 'recrutement': return 'from-orange-500 to-red-500';
    case 'conference': return 'from-indigo-500 to-purple-600';
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-blue-400 font-semibold">10 Décembre 2025</span>
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-brand-neutral max-w-4xl mx-auto leading-relaxed">
              Ce rendez-vous incontournable permet aux futurs ingénieurs agronomes et aux jeunes diplômés de rencontrer des entreprises prestigieuses
            </p>
      ...
      <section className="section-container">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-lg text-brand-gray leading-relaxed space-y-6">
            ...
            <p>
              Au-delà des simples échanges, le Forum offre également des panels, des sessions de formations 
              et des ateliers sur des thématiques cruciales. L'objectif est d'améliorer les profils des 
              étudiants agronomes pour un avenir meilleur de notre écosystème.
            </p>
          </div>
        </motion.div>
          ...
          <div className="relative z-10 grid md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">43 Avenue Charles Nicolle, Tunis</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
          ...
          {timeline2025.map((item, index) => (
            ...
            >
              <div className="flex-shrink-0 w-32 text-right mr-8">
                <div className="text-lg font-semibold text-brand-black">{item.time}</div>
              </div>
              
              <div className="flex-shrink-0 relative">
                <motion.div
                  whileHover={{ scale: 1.2 }}
                  className={`w-4 h-4 bg-gradient-to-r ${getTypeColor(item.type)} rounded-full border-4 border-white shadow-lg z-10 relative`}
                />
              ...
              <div className="flex-1 ml-8">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`px-3 py-1 bg-gradient-to-r ${getTypeColor(item.type)} text-white text-xs font-medium rounded-full`}>
                      {item.type}
                    </span>
                  </div>
                </motion.div>
      ...
      <section className="section-container">
        ...
        >
          ...
          <div className="bg-brand-neutral/30 rounded-3xl p-16 border-2 border-dashed border-brand-green/30">
            ...
            <h3 className="text-2xl font-semibold mb-4 text-brand-black">Galerie Photo</h3>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {pastEditions.map((edition, index) => (
            ...
            >
              <h3 className="text-3xl font-bold text-brand-green mb-4">{edition.year}</h3>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-brand-gray">Participants:</span>
                  <span className="font-semibold text-brand-black">{edition.participants}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-brand-gray">Entreprises:</span>
                  <span className="font-semibold text-brand-black">{edition.companies}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-brand-gray">Taux de placement:</span>
                  <span className="font-semibold text-brand-green">{edition.placements}</span>
                </div>
              </div>
            </motion.div>
          ))}
      ...
      <section className="section-container bg-brand-darkgray text-white">
        ...
        >
          ...
          <p className="text-lg text-brand-neutral mb-8">
            Découvrez tous les détails de l'événement dans notre présentation complète
          </p>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            <ExternalLink size={48} className="mx-auto mb-4 text-brand-green" />
            <h3 className="text-xl font-semibold mb-4">Présentation Complète</h3>
            <p className="text-brand-neutral mb-6">[PLACEHOLDER: Link to Canva presentation]</p>
