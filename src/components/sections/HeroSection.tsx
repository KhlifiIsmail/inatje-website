  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-brand-black/80 via-brand-black/60 to-brand-black/40 z-10" />
        <div className="w-full h-full bg-brand-darkgray">
          {/* Placeholder - Replace with actual image */}
          {/* <Image src="/images/hero/hero-bg.jpg" alt="INAT JE Hero" fill className="object-cover" priority /> */}
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-brand-green font-semibold">le développement durable</span>{' '}
            et <span className="text-brand-green font-semibold">l'excellence professionnelle</span>.
          </motion.p>
