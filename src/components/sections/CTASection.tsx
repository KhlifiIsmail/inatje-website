    ...
    <section className="section-container bg-brand-darkgray text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm font-medium">Prêt à démarrer votre projet ?</span>
        </motion.div>
        ...
        >
          Que vous soyez une entreprise, une organisation ou un porteur de projet, 
        ...
        >
          <Link href="/contact">
            <Button variant="primary" size="lg" className="group bg-brand-green hover:bg-brand-lightgreen w-full sm:w-auto">
              Contactez-nous
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Button>
          </Link>
          <Link href="/services">
            <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-brand-black w-full sm:w-auto">
        ...
        >
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-brand-green mb-2">150+</div>
              <div className="text-sm text-brand-neutral">Projets réalisés</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-brand-green mb-2">13 ans</div>
              <div className="text-sm text-brand-neutral">D'expérience</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-brand-green mb-2">100%</div>
              <div className="text-sm text-brand-neutral">Satisfaction client</div>
            </div>
          </div>
        </motion.div>
      </div>
